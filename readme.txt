...
If you are experiencing issues such as long loading times, you can try pre-downloading all the sprites using the spritepack installer from the discord and using Game-preloaded.exe to launch the game.

Savefile location: C:\Users\%USERNAME%\AppData\Roaming\infinitefusion\Game.rxdata
...
Showdown:        https://play.pokeathlon.com
Fusion dex:      https://if.daena.me
